...
/**
 * Mantengo tu const pestañas aquí para que todo quede en un solo archivo
 */
const pestañas = [
                      ...
                      <div className="col-12 col-sm-6 col-md-4" key={c.id}>
                        <div className="card h-100">
                          <div
                            ...
                            style={{
                              backgroundImage: `url('${c.foto || partido.logo || `/logos/${partido.id}.svg`}')`,
                              backgroundSize: "cover",
                              backgroundPosition: "center",
                            }}
                            aria-hidden
